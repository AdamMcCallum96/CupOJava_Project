...
public class UserDAO {
	...
	private final String SQL_CREATE_STUDENT = "INSERT INTO transitUsers (name, email) VALUES (?,?)";
	...
	public boolean createStudent(User user) {
		return jdbcTemplate.update(SQL_CREATE_STUDENT, user.getUsername(), user.getPassword(), user.getFirstName(), user.getLastName()) > 0;
	}
